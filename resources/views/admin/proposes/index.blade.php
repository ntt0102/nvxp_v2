...
<link rel="stylesheet" href="{{ asset('dist/admin/proposes/proposes.css?update=20190423') }}">
            ...
            <div class="card-header">
                ...
                <div class="card-tools">
                    <div class="input-group input-group-sm" style="width: 250px;">
                        @includeIf('_partials.search', ['value' => $search, 'link' => route('admin::proposes')])
...
<script src="{{ asset('dist/admin/proposes/proposes.js?update=20190423') }}"></script>
@endsection